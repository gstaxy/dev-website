...
// Image
const slevanPhoto = toArrayBuffer(
  readFileSync(join(process.cwd(), "public/images/black_hole_magnetic_field.png"))
);
          ...
          <div tw="flex flex-row">
            ...
            <div tw="flex flex-col px-10 grow text-[28px] h-70 justify-center">
              ...
              <div tw="flex mb-5" style={font("Roboto Mono 400")}>
                <span tw="text-gray-400 mr-3">&mdash;</span> Senior Machine Learning Engineer @ Pod
              </div>
              <div tw="flex mb-5" style={font("Roboto Mono 400")}>
                <span tw="text-gray-400 mr-3">&mdash;</span> Startup focused on building AI products.
              </div>
              <div tw="flex" style={font("Roboto Mono 400")}>
                <span tw="text-gray-400 mr-3">&mdash;</span> Lives in BC, Canada
              </div>
            </div>
          </div>
        </main>
